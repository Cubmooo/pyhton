...
while user_score < target_score and comp_score <target_score:
    ...
    while computer_points <= target_score and user_points <= target_score:
        ...
        if roll_again == "yes":
            ...
            if user_points > target_score:
                print(f"💥💥💥 Oops! You rolled a {user_move} so your total is {user_points}.  "
                      f"Which is over {target_score} points .💥💥💥")
        ...
        if computer_points >= target_score-3 and computer_points >= user_points:
            computer_pass = "yes"
        ...
        # has been met in a previous iteration through the loop.
            ...
            if computer_points > target_score:
                print(f"💥💥💥The computer rolled a {computer_move}, taking their points"
                      f" to {computer_points}.  This is over {target_score} points so the computer loses!💥💥💥")
                computer_points = 0
                break
