...
def randomquestions(avaliblenextsquares,lastsquare,correctnextsquare,difficulty,randomquestionsettings):
    ...
    try:
        ...
        return useranswer,difficulty,randomquestionsettings,questionfail
    except:
        print("test2")
        questionfail=True
        useranswer=0
...
def maze(lastSquare,canvas,lineplace,directions,correctdirections,difficulty,randomquestionsettings):
    ...
    while mazeDone==False:# repeat until maze done
        ...
        try:
            ...
            correctnextsquare=0
        nextsquare,difficulty,randomquestionsettings,questionfail=randomquestions(avaliblenextsquares,lastSquare,correctnextsquare,difficulty,randomquestionsettings)# ask what move they want next then add that to directions and mark that area as having been in
        if hold==False:
