...
def randomquestions(avaliblenextsquares,lastsquare,correctnextsquare):     
    dificulty=3
    number1=0
    number2=0
    operations=["+","-","*","/"]
...
def maze(lastSquare,canvas,lineplace,directions,correctdirections):
    hold=False
    mazeDone=False
    while mazeDone==False:# repeat until maze done
        ...
        try:
            ...
            correctnextsquare=0
        nextsquare=randomquestions(avaliblenextsquares,lastSquare,correctnextsquare)# ask what move they want next then add that to directions and mark that area as having been in
        if hold==False:
...
def start():
    ...
    while True:
        directions,holddirections,holdcanvas,holdlineplace=maze(lastSquare,canvas,lineplace,directions,correctdirections)
