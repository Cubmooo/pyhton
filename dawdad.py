...
if rounds_played > 0:
    ...
    # ask user if they want to see their gam history and output it if requested.
    ...
    # if the user plays infinite mode and
    # chickens out, we don't try to calculate the statistics.
